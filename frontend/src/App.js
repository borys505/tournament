...
import JoinTournamentRoom from "./tournament/jointournamentroom";
/*
 *  Frontend flow:
 *
  ...
  return (
    ...
    >
      <Router>
        <Switch>
          <Route path="/" exact>
            <Onboard setUserName={setUserName} userName={userName} />
          </Route>
          ...
          <Route path="/tournament/:tournamentid" exact>
            {didRedirect ? (
              <React.Fragment>
                <JoinTournament userName={userName} isCreator={true}/>
                <ChessGameTournament myUserName={userName}/>
              </React.Fragment>
            ) : (
              <JoinTournamentRoom />
            )}
